...
const Experience = () => {
  return (
    <div className="mx-24 my-20 mb-36">
      <div className="text-3xl text-pink-main">My experience so far</div>
      <div className="mt-5 mx-24 w-120">
        <div className="mb-12">
          <div className="text-2xl text-rose-main">Ikarus3D</div>
          <div className="text-xl text-green-main">
            (Software Development Associate Intern)
          </div>
          <div className="text-rose-main">June 2022 - November 2022</div>
        ...
        <div className=" mb-12">
          ...
          <div className="text-rose-main">September 2021 - Current</div>
          <div className="text-peach-main">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit excepturi illum nobis veritatis iure eos deleniti optio, enim autem laborum voluptas modi molestiae tenetur ipsam error, voluptates eligendi itaque! Aliquid!</div>
        </div>
